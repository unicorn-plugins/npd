# NPD: ext-github-release-manager 스킬 워크플로우

> [!NOTE]
> 이 워크플로우는 NPD ext-github-release-manager 단계를 실행합니다.
...
3. 파악한 플러그인 루트 경로 하위의 "skills/ext-github-release-manager/SKILL.md" 문서를 "view_file" 로 꼼꼼히 읽으세요.
