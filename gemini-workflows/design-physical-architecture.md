# NPD: design-physical-architecture 스킬 워크플로우

> [!NOTE]
> 이 워크플로우는 NPD design-physical-architecture 단계를 실행합니다.
...
3. 파악한 플러그인 루트 경로 하위의 "skills/design-physical-architecture/SKILL.md" 문서를 "view_file" 로 꼼꼼히 읽으세요.
