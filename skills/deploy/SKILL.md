...
- **GUIDE**: `{NPD_PLUGIN_DIR}/resources/guides/deploy/deploy-pre-setup.md` 참조
...
- **GUIDE**: `{NPD_PLUGIN_DIR}/resources/guides/deploy/backing-service/backing-service-container.md` 참조
...
- **GUIDE**: `{NPD_PLUGIN_DIR}/resources/guides/deploy/backing-service/backing-service-k8s.md` 참조
- **CONTEXT**: 조립된 `[실행정보]` 블록을 프롬프트에 포함
