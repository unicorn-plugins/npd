...
- 복수 서비스 병행 개발 시 서비스별 독립 domain-expert 관리 (서비스별 프로젝트 디렉토리에 생성)
...
2. /npd:create   → 새 프로젝트 생성 (디렉토리 생성 + AGENTS.md 생성 + GitHub 레포)
...
| `/npd:help` | 이 도움말 출력 |
| `/npd:create` | 새 프로젝트 생성 (디렉토리 생성 + AGENTS.md 생성 + GitHub 레포) |
...
| `domain-expert` | HIGH | 기획 | 도메인 특화 지식 (plan의 MVP정의 시 동적 생성) |
