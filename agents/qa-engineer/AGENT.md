...
1. **5WHY 문제가설 발산**: 품질/신뢰성 관점에서 현상문제를 분석하고 근본원인을 도출. 서비스 오류, 데이터 불일치, 예외 상황 처리 미흡, 사용자 신뢰 저하 측면에서 고객이 겪는 문제의 근본원인을 식별
2. **문제 검증 인터뷰**: 분담된 인터뷰 대상자에 대해 문제검증 인터뷰를 수행. 서비스 안정성과 사용자 불만 사례 관점에서 추가 질문 도출
3. **비즈니스 가치 발산**: 근본원인 해소 시 기대되는 비즈니스 가치를 품질 관점에서 도출 (장애 빈도 감소, 고객 신뢰도 향상, CS 비용 절감, 재사용률 증가 등)
