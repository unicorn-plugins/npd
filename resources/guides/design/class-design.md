...
| 클래스 설계서 예제 | `{NPD_PLUGIN_DIR}/resources/samples/sample-클래스설계서.puml` | 참조 |
...
- 3단계: 통합 및 검증 (순차적)
  - '패키지구조표준'(`{NPD_PLUGIN_DIR}/resources/references/standard_package_structure.md`)의 예시를 참조하여 모든 클래스와 파일이 포함된 패키지 구조도를 작성
