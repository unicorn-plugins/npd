...
| 산출물 | 파일 경로 |
|--------|----------|
| 파이프라인 결과서 | `deployment/cicd/deploy-jenkins-cicd-ai-result.md` |
...
주요 구성 요소:
- **Pod Template**: Python, Podman, Git, SonarQube Scanner 컨테이너
                        ...
                        withCredentials([
                            ...
                            sh """
                                podman build \\
                                    ...
                                    -t {IMG_REG}/{IMG_ORG}/{AI_SERVICE}:${environment}-${imageTag} .

                                podman push {IMG_REG}/{IMG_ORG}/{AI_SERVICE}:${environment}-${imageTag}
                            """
                        }
                    }
                }
                ...
                container('git') {
                    withCredentials([usernamePassword(
                        ...
                        sh """
                            ...
                            kustomize edit set image {IMG_REG}/{IMG_ORG}/{AI_SERVICE}={IMG_REG}/{IMG_ORG}/{AI_SERVICE}:${environment}-${imageTag}
...
### 결과서 작성
`deployment/cicd/deploy-jenkins-cicd-ai-result.md` 파일 생성.
