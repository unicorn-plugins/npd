...
| 산출물 | 파일 경로 |
|--------|----------|
| 백킹서비스 배포 결과서 | `docs/deploy/backing-service-container-result.md` |
...
> **MySQL/MariaDB healthcheck**: `{NPD_PLUGIN_DIR}/resources/guides/deploy/backing-service/backing-rdb-container.md` 참조
> **MongoDB healthcheck**: `{NPD_PLUGIN_DIR}/resources/guides/deploy/backing-service/backing-nosql-container.md` 참조
> **Cloud MQ 프로비저닝**: `{NPD_PLUGIN_DIR}/resources/guides/deploy/backing-service/backing-mq-container.md` 참조
...
> - RDB: `{NPD_PLUGIN_DIR}/resources/guides/deploy/backing-service/backing-rdb-container.md`
> - NoSQL: `{NPD_PLUGIN_DIR}/resources/guides/deploy/backing-service/backing-nosql-container.md`
...
Health Check 완료 후 `docs/deploy/backing-service-container-result.md`를 작성한다.
선택된 제품에 맞게 연결 정보를 작성한다. 제품별 보고서 템플릿은 해당 카테고리 가이드 참조:
- RDB (MySQL/MariaDB): `{NPD_PLUGIN_DIR}/resources/guides/deploy/backing-service/backing-rdb-container.md`
- NoSQL (MongoDB): `{NPD_PLUGIN_DIR}/resources/guides/deploy/backing-service/backing-nosql-container.md`
- MQ (Cloud MQ): `{NPD_PLUGIN_DIR}/resources/guides/deploy/backing-service/backing-mq-container.md`

## 출력 형식

`docs/deploy/backing-service-container-result.md` 결과 보고서 템플릿:
...
- [ ] `docs/deploy/backing-service-container-result.md`가 작성됨
