...
## 목적
AI 서비스(Python FastAPI 기반)를 AKS 쿠버네티스에 배포하기 위한 매니페스트 파일 작성.
...
- AI 서비스 디렉토리의 `.env.example` 파일을 읽어 환경변수를 추출.
...
## 주의사항
- Ingress annotation에 `nginx.ingress.kubernetes.io/rewrite-target` 설정 절대 하지 말 것.
