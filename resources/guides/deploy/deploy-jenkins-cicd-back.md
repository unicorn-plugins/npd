...
## 목적
Jenkins + Kustomize 기반 백엔드 CI/CD 파이프라인을 구축한다. 환경별(dev/staging/prod) 매니페스트를 Kustomize overlay로 관리하고, SonarQube 코드 품질 분석과 Quality Gate를 포함한 자동 배포 파이프라인을 구현한다.
